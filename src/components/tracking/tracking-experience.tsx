...
const trackingText = {
  ...
  en: {
    subtitle: "Follow ETA, branch assignment, and each milestone of the order with clarity.",
    detailTitle: "Order details",
    timelineTitle: "Progress timeline",
    reorder: "Reorder this selection",
    empty: "No orders are available yet",
  },
  ja: {
    subtitle: "到着予定時刻、担当店舗、進行状況を一画面で追えます。",
    detailTitle: "注文詳細",
    timelineTitle: "進行状況",
    reorder: "この内容で再注文",
    empty: "表示できる注文がありません",
  ...
  zh: {
    subtitle: "在同一页面查看 ETA、负责门店与每个阶段的进度。",
    detailTitle: "订单详情",
    timelineTitle: "进度时间线",
    reorder: "按此内容再次下单",
    empty: "暂无可追踪订单",
  ...
  ko: {
    subtitle: "ETA, 담당 지점, 진행 단계를 한 화면에서 확인할 수 있습니다.",
    detailTitle: "주문 상세",
    timelineTitle: "진행 단계",
    reorder: "이 주문 다시 담기",
    empty: "표시할 주문이 없습니다",

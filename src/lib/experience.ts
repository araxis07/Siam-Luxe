...
const testimonials: TestimonialDefinition[] = [
  ...
  },
  {
    ...
    quote: {
      ...
      en: "Tracking, branch selection, and promo flow make ordering feel complete and reassuring.",
      ja: "追跡、店舗選択、クーポン導線まであり、完成度が高いです。",
      zh: "追踪、门店选择与优惠码流程都很完整，让整体体验显得非常成熟。",
...
const faqs: FaqDefinition[] = [
  ...
  },
  {
    ...
    answer: {
      th: "ตอนนี้ลูกค้าสามารถเลือกเวลา ที่นั่ง และรายละเอียดการจองได้ครบใน flow เดียว และพร้อมต่อยอดสู่การยืนยันตารางจริงได้ภายหลัง",
      en: "Guests can already choose timing, seating, and reservation details in one flow, with room to confirm against live schedules later.",
      ja: "時間、席種、予約詳細を一つの流れで選べる構成になっており、今後は実際の空席確認にもつなげやすくなっています。",
      zh: "顾客已经可以在一个流程中完成时间、座位与预订细节的选择，后续也便于接入真实档期确认。",
      ko: "고객은 한 흐름 안에서 시간, 좌석, 예약 세부 정보를 모두 고를 수 있으며 이후 실제 일정 확인과도 자연스럽게 연결할 수 있습니다.",
    },
  },
  {
    id: "voucher",
  ...
  },
  {
    ...
    answer: {
      th: "หน้าบัญชีจะแสดงแต้มสะสม ระดับสมาชิก สิทธิ์ถัดไป และคำสั่งซื้อก่อนหน้าไว้ในแดชบอร์ดเดียว",
      en: "The account page brings your point balance, tier, next reward, and order history into one dashboard.",
      ja: "アカウント画面で保有ポイント、会員ランク、次の特典、注文履歴を一つの画面で確認できます。",
      zh: "账户页面会把积分、会员等级、下一奖励与历史订单集中展示在同一仪表板中。",
      ko: "계정 페이지에서 포인트, 등급, 다음 혜택, 주문 내역을 하나의 대시보드로 확인할 수 있습니다.",
    },
  },
];
...
const experienceCopy = {
  th: {
    ...
    labels: {
      ...
      dietaryNote: "หมายเหตุ: ป้ายกำกับนี้ช่วยให้ดูข้อมูลด้านอาหารได้เร็วขึ้น หากมีข้อกังวลเฉพาะควรสอบถามทีมร้านเพิ่มเติม",
    },
  },
  en: {
    serviceModes: {
    ...
    labels: {
      ...
      dietaryNote: "Note: these labels help guests scan dietary guidance quickly. Please confirm specific allergy concerns with the house team.",
    },
  },
  ja: {
    serviceModes: {
    ...
    labels: {
      ...
      dietaryNote: "注記: これらの表示は食事条件を素早く確認するための案内です。個別のアレルギーは店舗へご確認ください。",
    },
  },
  zh: {
    serviceModes: {
    ...
    labels: {
      ...
      dietaryNote: "说明：这些标签用于快速查看饮食信息，如有具体过敏疑虑请再向门店确认。",
    },
  },
  ko: {
    serviceModes: {
    ...
    labels: {
      ...
      dietaryNote: "참고: 이 표시는 식단 정보를 빠르게 살펴보기 위한 안내이며, 구체적인 알레르기 사항은 매장에 다시 확인해 주세요.",
    },
  },
} as const;

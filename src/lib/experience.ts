...
const featureLinks: FeatureLinkDefinition[] = [
  ...
  },
  {
    ...
    description: {
      ...
      ja: "支店、人数、利用シーン、席の希望まで選べる予約 UI。",
      zh: "可选择分店、人数、场合与座位偏好的预约界面。",
      ko: "지점, 인원, 방문 목적, 좌석 취향까지 선택하는 예약 UI입니다.",
    },
  ...
  },
  {
    ...
    description: {
      th: "ดูสถานะ ETA สาขาที่รับผิดชอบ และลำดับขั้นของออเดอร์แบบ frontend mock",
      en: "Live-style status, ETA, branch handoff, and progress timeline.",
      ja: "ETA、担当店舗、進行状況を追えるトラッキング画面です。",
      zh: "查看 ETA、负责门店与订单阶段时间线。",
      ko: "ETA, 담당 지점, 진행 단계를 한 화면에서 확인할 수 있습니다.",
    },
  ...
  },
  {
    ...
    description: {
      th: "บันทึกจานที่อยากสั่งซ้ำ แล้วดึงกลับเข้า cart ได้เร็วขึ้น",
  ...
  },
  {
    ...
    description: {
      th: "landing page สำหรับสงกรานต์ ลอยกระทง และฤดูกาลพิเศษในโทนพรีเมียม",
  ...
  },
  {
    ...
    description: {
      th: "หน้า inquiry สำหรับ private room, corporate dinner, celebration และ chef table",
  ...
  },
  {
    ...
    description: {
      ...
      ja: "注文、アレルゲン、受取、予約、特典に関する FAQ を掲載。",
      zh: "集中解答订单、过敏原、自取、预订与优惠券问题。",
      ko: "주문, 알레르기, 픽업, 예약, 바우처 관련 FAQ를 제공합니다.",
    },
...
const branches: BranchDefinition[] = [
  ...
  },
  {
    ...
    features: [
      ...
      {
        th: "มีโซนสวนและ private tasting room",
...
const specials: SpecialDefinition[] = [
  {
    ...
    title: {
      th: "Royal Evening Tasting",
      en: "Royal Evening Tasting",
      ja: "Royal Evening Tasting",
      zh: "Royal Evening Tasting",
      ko: "Royal Evening Tasting",
    },
    description: {
  ...
  },
  {
    ...
    title: {
      th: "Regional Journey Samrub",
      en: "Regional Journey Samrub",
      ja: "Regional Journey Samrub",
      zh: "Regional Journey Samrub",
      ko: "Regional Journey Samrub",
    },
    description: {
  ...
  },
  {
    ...
    title: {
      th: "Songkran Lotus Collection",
      en: "Songkran Lotus Collection",
      ja: "Songkran Lotus Collection",
      zh: "Songkran Lotus Collection",
      ko: "Songkran Lotus Collection",
    },
    description: {
...
const testimonials: TestimonialDefinition[] = [
  {
    ...
    quote: {
      ...
      ja: "単なるメニューではなく、本当に運用できる高級店の UI に見えます。",
  ...
  },
  {
    ...
    quote: {
      th: "การเลือกเมนูตามภูมิภาคและดู tasting set ช่วยให้เข้าใจอาหารไทยได้ง่ายขึ้นมาก",
  ...
  },
  {
    ...
    quote: {
      th: "ผมชอบที่มี tracking, branch selector และ promo code ครบ ทำให้หน้าบ้านดู production-ready มาก",
...
const faqs: FaqDefinition[] = [
  {
    ...
    answer: {
      th: "แต่ละเมนูจะแสดง dietary labels เช่น seafood, nuts, vegetarian และสามารถตรวจซ้ำได้ในหน้า Help Center นี้",
      ...
      ja: "各メニューに seafood、nuts、vegetarian などの表示があり、このヘルプでも再確認できます。",
      zh: "每道菜都会显示如 seafood、nuts、vegetarian 等饮食标签，本页也可再次确认。",
      ko: "각 메뉴 카드에 seafood, nuts, vegetarian 같은 태그가 표시되며 이 도움말에서도 다시 확인할 수 있습니다.",
    },
  },
  {
    id: "pickup",
    question: {
      th: "ถ้าเลือก pickup ต้องทำอย่างไร",
    ...
    answer: {
      th: "เลือก pickup จาก service mode แล้วระบบจะใช้สาขาที่คุณเลือกเป็นจุดรับสินค้า พร้อมเวลารับโดยประมาณในหน้า Tracking",
      en: "Switch the service mode to pickup, choose a branch, and the tracking page will show the handoff time and pickup branch.",
      ja: "service mode を pickup に切り替え、店舗を選ぶと、追跡ページに受取時間と店舗が表示されます。",
      zh: "将 service mode 切换为 pickup 后选择门店，Tracking 页面会显示取餐时间与门店。",
      ko: "service mode를 pickup으로 바꾸고 지점을 선택하면 Tracking 페이지에서 수령 시간과 지점을 볼 수 있습니다.",
    },
  },
  {
    id: "reservation",
    question: {
      th: "หน้า Reservation เชื่อม backend จริงหรือยัง",
    ...
    answer: {
      th: "ยังเป็น frontend-only mock แต่โครงฟอร์ม เวลา ที่นั่ง และการยืนยัน ถูกจัดให้พร้อมเชื่อม API ภายหลังได้ง่าย",
      ...
      ja: "現在はフロントエンドのみですが、フォームと確認導線は API 連携しやすい構成です。",
      zh: "目前仍是纯前端模拟，但表单与确认流程已经按后续接 API 的方式组织。",
      ko: "현재는 프런트엔드 전용 목업이지만 폼과 확인 흐름은 이후 API 연결이 쉽도록 구성되어 있습니다.",
    },
  },
  {
    id: "voucher",
    question: {
      th: "ใช้ promo code ได้ตรงไหน",
    ...
    answer: {
      th: "กรอกรหัสได้ทั้งใน Cart Drawer และ Checkout โดยระบบจะแสดงส่วนลดที่ใช้ได้กับยอดปัจจุบัน",
  ...
  },
  {
    ...
    question: {
      ...
      ja: "ポイント表示はどうなっていますか",
      zh: "会员积分界面如何运作？",
      ko: "포인트 UI는 어떻게 동작하나요?",
    },
    answer: {
      th: "หน้า Account จะแสดงแต้มสะสม ระดับสมาชิก สิทธิ์ถัดไป และคำสั่งซื้อก่อนหน้าในรูปแบบ frontend prototype",
      ...
      zh: "Account 页面会展示积分、会员等级、下一奖励与历史订单的前端原型。",
      ko: "Account 페이지에서 포인트, 등급, 다음 혜택, 주문 내역을 프런트엔드 프로토타입으로 볼 수 있습니다.",
    },
  },
];
...
const notifications: NotificationDefinition[] = [
  ...
  },
  {
    id: "notif-2",
    title: {
      th: "Bangrak Salon มีโต๊ะว่างรอบค่ำ",
  ...
  },
  {
    id: "notif-3",
    title: {
      th: "แต้มของคุณใกล้ถึงระดับ Royal Gold",
      en: "You are close to Royal Gold tier",
      ja: "Royal Gold まであと少し",
      zh: "你即将达到 Royal Gold 等级",
      ko: "Royal Gold 등급까지 얼마 남지 않았습니다",
    },
    body: {
...
const loyaltyTiers: LoyaltyTierDefinition[] = [
  ...
  },
  {
    ...
    description: {
      th: "รับสิทธิ์ของหวาน complimentary และ early access เมนูพิเศษ",
  ...
  },
  {
    ...
    description: {
      th: "Priority reservation และ chef tasting invitations",
...
const experienceCopy = {
  th: {
    ...
    labels: {
      ...
      trackingBody: "ดู ETA และลำดับสถานะของแต่ละออเดอร์",
      favoritesTitle: "เมนูโปรด",
      favoritesBody: "บันทึกจานที่อยากสั่งซ้ำไว้ใน wishlist",
      ...
      chefRecommendationTitle: "Chef Recommendation",
      chefRecommendationBody: "คัดจากรูปแบบการสั่งและภูมิภาคที่คุณกำลังดูอยู่",
      ...
      pickupHint: "หากเลือก pickup ระบบจะยืนยันสาขารับสินค้าให้ทันที",
      dietaryNote: "หมายเหตุ: ป้ายกำกับนี้เป็นตัวอย่าง frontend สำหรับเชื่อมข้อมูลครัวจริงในภายหลัง",
    },
  },
  en: {
    serviceModes: {
  ...
  ja: {
    ...
    labels: {
      ...
      mapLabel: "店舗マップ",
      supportLine: "サービスライン",
      pickupHint: "pickup を選ぶと受取店舗が自動で反映されます。",
  ...
  zh: {
    ...
    labels: {
      ...
      trackingTitle: "订单追踪",
      trackingBody: "查看 ETA 与订单阶段。",
      favoritesTitle: "收藏夹",
      favoritesBody: "保存之后想再次点的菜品。",
      accountTitle: "我的账户",
      accountBody: "资料、积分、地址与通知整合在一起。",
      helpTitle: "帮助中心",
      helpBody: "关于自取、预订、优惠与过敏原的 FAQ。",
      noFavorites: "还没有收藏菜品",
      addFavorite: "加入收藏",
      removeFavorite: "取消收藏",
      ...
      mapLabel: "门店地图",
      supportLine: "门店服务专线",
      pickupHint: "选择 pickup 后，界面会自动确认取餐门店。",
  ...
  ko: {
    ...
    labels: {
      ...
      pickupHint: "pickup을 선택하면 수령 지점이 자동으로 반영됩니다.",

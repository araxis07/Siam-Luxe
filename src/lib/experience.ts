...
const faqs: FaqDefinition[] = [
  {
    ...
    answer: {
      th: "แต่ละเมนูจะแสดงป้ายกำกับด้านอาหาร เช่น ซีฟู้ด มีถั่ว มังสวิรัติ และตรวจซ้ำได้ในหน้า Help Center นี้",
  ...
  },
  {
    ...
    answer: {
      th: "เลือก pickup จากวิธีรับสินค้า แล้วระบบจะใช้สาขาที่คุณเลือกเป็นจุดรับสินค้า พร้อมเวลารับโดยประมาณในหน้าติดตามคำสั่งซื้อ",
      en: "Switch the service mode to pickup, choose a branch, and the tracking page will show the handoff time and pickup branch.",
      ja: "受取方法を pickup に切り替えて店舗を選ぶと、追跡ページに受取時間と店舗が表示されます。",
      zh: "将服务方式切换为 pickup 后选择门店，订单追踪页会显示取餐时间与门店。",
      ko: "이용 방식을 pickup으로 바꾸고 지점을 선택하면 주문 추적 페이지에서 수령 시간과 지점을 볼 수 있습니다.",
    },
  },
  {
    id: "reservation",
    ...
    answer: {
      th: "ตอนนี้ยังเป็นตัวอย่างฝั่งหน้าเว็บ แต่โครงฟอร์ม เวลา ที่นั่ง และการยืนยัน ถูกวางไว้ให้เชื่อม API ภายหลังได้ง่าย",
  ...
  },
  {
    ...
    answer: {
      th: "หน้า Account จะแสดงแต้มสะสม ระดับสมาชิก สิทธิ์ถัดไป และคำสั่งซื้อก่อนหน้าในรูปแบบต้นแบบฝั่งหน้าเว็บ",
...
const experienceCopy = {
  th: {
    ...
    labels: {
      ...
      pickupHint: "หากเลือกการรับเอง ระบบจะยืนยันสาขารับสินค้าให้ทันที",

    ...
    <html lang="en">
      <body className="min-h-screen bg-[#0b0909] px-4 text-white">
        <main className="mx-auto flex min-h-screen max-w-3xl flex-col items-center justify-center text-center">
          <p className="text-[0.7rem] uppercase tracking-[0.22em] text-[#d6b26a]">Unexpected Error</p>
          <h1 className="mt-4 font-heading text-[3rem] leading-tight">Something broke in the frontend layer</h1>
          <p className="mt-4 max-w-xl text-[#d1c4b2]">
            {error.message || "An unknown rendering error occurred. You can retry the current route or go back home."}
          </p>
